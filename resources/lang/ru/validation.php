...
return [
    ...
    */
    ...
    'required_if' => 'Поле ":attribute" является обязательным, если поле ":other" равно :value.',
    'required_unless' => 'Поле ":attribute" является обязательным, unless :other is in :values.',
    'required_with' => 'The :attribute field is required when :values is present.',
    'required_with_all' => 'The :attribute field is required when :values are present.',
    'required_without' => 'Поле ":attribute" является обязательным для заполнения, если поле ":values" не указано.',
