    ...
    children: [
      {
        ...
        show: true,
        active: isActive('dictionary.printers.index'),
      },
      {
        id: '05-02',
        ...
        show: true,
        active: isActive('dictionary.consumables.index'),
      },
      {
        id: '05-03',
        name: 'Организации',
        ...
        show: isAdmin.value,
        active: isActive('dictionary.organizations.index'),
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        show: true,
        active: isActive('orders.spare-parts.index'),
      },
      {
        id: '06-02',
        name: 'Картриджи',
        ...
        show: true,
        active: isActive('orders.consumables.index'),
      },
      {
        id: '06-03',
        name: 'Мелочи',
        ...
        show: true,
        active: isActive('orders.misc.index'),
      },
    ],
  },
  {
