    ...
    <form @submit.prevent="exportToExcel">
        ...
        <!--Panel header="Период" class="mt-4">
            ...
            <div class="mt-3" v-if="!form.withoutPeriod">
                с <input type="date" v-model="form.dateFrom" :disabled="form.withoutPeriod" class="bg-white border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" />
                по <input type="date" v-model="form.dateTo" :disabled="form.withoutPeriod" class="bg-white border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" />
            </div>
        </Panel-->
